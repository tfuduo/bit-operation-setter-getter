...
public class Cat {
    ...
    public void setCute(boolean cute) {
        this.properties = cute ? (properties | Cat.CUTE) : (properties & (~Cat.CUTE));
    }
    ...
    public void setFat(boolean fat) {
        this.properties = fat ? (properties | Cat.FAT) : ( properties & (~Cat.FAT));
    }
    ...
    public void setWhite(boolean white) {
        this.properties = white ? (properties | Cat.WHITE) : (properties & (~Cat.WHITE));
    }
