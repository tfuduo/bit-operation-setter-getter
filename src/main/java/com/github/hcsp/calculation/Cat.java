...
public class Cat {
    ...
    public void setCute(boolean cute) {
        properties = cute? properties | CUTE : isCute() ? properties ^ CUTE : properties;
    }
    ...
    public void setFat(boolean fat) {
        properties = fat? properties | FAT : isFat() ? properties ^ FAT : properties;
    }
    ...
    public void setWhite(boolean white) {
        properties = white? properties | WHITE : isWhite() ? properties ^ WHITE : properties;
    }
