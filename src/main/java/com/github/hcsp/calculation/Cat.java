...
public class Cat {
    ...
    public boolean isCute() {
        return (properties | CUTE) == properties;
    }
    ...
    public boolean isFat() {
        return (properties | FAT) == properties;
    }
    ...
    public boolean isWhite() {
        return (properties | WHITE) == properties;
    }
