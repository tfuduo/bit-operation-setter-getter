...
public class Cat {
    ...
    public boolean isCute() {
        return (this.properties & Cat.CUTE) != 0;
    }
    ...
    public boolean isFat() {
        return (this.properties & Cat.FAT) != 0;
    }
    ...
    public boolean isWhite() {
        return (this.properties & Cat.WHITE) != 0;
    }
