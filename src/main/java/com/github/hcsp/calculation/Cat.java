...
public class Cat {
    ...
    public boolean isCute() {
        int cproperties = properties;
        return(cproperties &=0x1) == 0x1;
    }
    ...
    public boolean isFat() {
        int fproperties = properties;
        return  (fproperties &=0x2)==0x2;
    ...
    public boolean isWhite() {
        int wproperties = properties;
        return (wproperties &= 0x4) == 0x4;
    }
