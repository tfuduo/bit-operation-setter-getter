...
public class Cat {
    ...
    public void setCute(boolean cute) {
        if(cute){
            this.properties = properties | CUTE;
        }else if(CUTE == (properties & CUTE)){
            this.properties = properties ^ CUTE;
        }
    }
    ...
    public boolean isCute() {
        ...
        return CUTE == (this.properties & CUTE);
    ...
    public void setFat(boolean fat) {
        ...
        }else if(FAT == (properties & FAT)){
            this.properties = properties ^ FAT;
        }
    }
    ...
    public boolean isFat() {
        return FAT == (this.properties & FAT);
    }
    ...
    public void setWhite(boolean white) {
        ...
        }else if(WHITE == (properties & WHITE)){
            this.properties = properties ^ WHITE;
        }
    }
